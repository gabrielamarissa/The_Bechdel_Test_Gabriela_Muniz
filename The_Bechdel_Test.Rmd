...
> The %>% inside the code is called a pipe that feeds the code through line after line. I googled the answer. 
...
> 'select()' allows you to select specific variables from the data set. I googled it, and I figured from 'select' with the some not all the variables that will be. 
